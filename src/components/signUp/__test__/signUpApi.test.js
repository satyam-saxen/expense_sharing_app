...
describe('Form', () => {
    test('fetches response from an API to create user', async () => { 
    ...
    test('fetches response from an API with some durty data as Bad Request', async () => { 
        const jsdomAlert = window.alert; // remember the jsdom alert
        window.alert = () => {};
